...
Decentralized Stable Coin Properties(in our example):
...
```
git clone https://github.com/MihaiHng/foundry-defi-stablecoin-f24.git
...
In this repo we cover Unit and Fuzzing.
